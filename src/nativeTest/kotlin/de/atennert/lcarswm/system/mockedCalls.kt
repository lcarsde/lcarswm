...
fun mockXCreateSimpleWindow(display: CValuesRef<Display>?, parent: Window, c: Int, d: Int, e: UInt, f: UInt, g: UInt, h: ULong, i: ULong) = 1.toULong()
...
fun mockXCreatePixmap(display: CValuesRef<Display>?, drawable: Drawable, width: UInt, height: UInt, depth: UInt): Pixmap = 0.toULong()
...
fun mockXftDrawCreate(display: CValuesRef<Display>?, drawable: Drawable, visual: CValuesRef<Visual>?, colormap: Colormap): CPointer<XftDraw>? {
...
fun mockXftDrawRect(xftDraw: CValuesRef<XftDraw>?, color: CValuesRef<XftColor>?, x: Int, y: Int, width: UInt, height: UInt) {}
...
fun mockPangoLayoutGetPixelExtents(layout: CValuesRef<PangoLayout>?, inkRect: CValuesRef<PangoRectangle>?, logicalRect: CValuesRef<PangoRectangle>?) {}

fun mockPangoLayoutGetLineReadonly(layout: CValuesRef<PangoLayout>?, line: Int): CPointer<PangoLayoutLine>? = null

fun mockPangoXftRenderLayoutLine(xftDraw: CValuesRef<XftDraw>?, color: CValuesRef<XftColor>?, layoutLine: CValuesRef<PangoLayoutLine>?, x: Int, y: Int) {}
