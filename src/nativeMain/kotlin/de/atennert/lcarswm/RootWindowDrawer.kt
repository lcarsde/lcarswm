...
//        // top bar
//        bars[0].x = (monitor.x + 48 + wmLogo.pointed.width).convert()
//        bars[0].y = monitor.y.toShort()
//        bars[0].width = (monitor.width - 88 - wmLogo.pointed.width).convert()
...
//            wmLogo, monitor.x + 40, monitor.y,
//            wmLogo.pointed.width.convert(), wmLogo.pointed.height.convert())
//
...
//        bigBars[0].width = (monitor.width - 318 - wmLogo.pointed.width).convert()
...
//
//        drawApi.putImage(rootWindow, gcCopyImage,
//            wmLogo, monitor.x + monitor.width - 40 - wmLogo.pointed.width, monitor.y,
//            wmLogo.pointed.width.convert(), wmLogo.pointed.height.convert())
//
//        nativeHeap.free(arcs)
//        nativeHeap.free(rects)
