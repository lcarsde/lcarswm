...
const val NORMAL_WINDOW_UPPER_OFFSET = 2 * BAR_HEIGHT + 3 * INNER_CORNER_RADIUS + 2 * BAR_GAP_SIZE + DATA_AREA_HEIGHT
const val NORMAL_WINDOW_NON_APP_HEIGHT = NORMAL_WINDOW_UPPER_OFFSET + BAR_GAP_SIZE + INNER_CORNER_RADIUS * 4 + BAR_HEIGHT
